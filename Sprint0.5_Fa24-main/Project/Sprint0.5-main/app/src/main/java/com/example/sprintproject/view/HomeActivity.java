...
public class HomeActivity extends AppCompatActivity {
    ...
    private LinearLayout navDestinations, navLogistics, navDining, navAccommodations, navTransportation, navTravel;
    private TextView lblDestinations, lblLogistics, lblDining, lblAccommodations, lblTransportation, lblTravel;
